...
export var allSettledPPolyfill = curryN(1, polyfill);
/**
...
var allSettledP = isFunction(Promise.allSettled) ? curryN(1, bind(Promise.allSettled, Promise)) : allSettledPPolyfill;
