...
export var isSafeIntegerPolyfill = curryN(1, polyfill);
/**
...
var isSafeInteger = isFunction(Number.isSafeInteger) ? curryN(1, bind(Number.isSafeInteger, Number)) : isSafeIntegerPolyfill;
