...
function find() {
    return purry_1.purry(_find(false), arguments, find.lazy);
}
exports.find = find;
...
(function (find) {
    function indexed() {
        return purry_1.purry(_find(true), arguments, find.lazyIndexed);
    }
    find.indexed = indexed;
    find.lazy = _toSingle_1._toSingle(_lazy(false));
    find.lazyIndexed = _toSingle_1._toSingle(_toLazyIndexed_1._toLazyIndexed(_lazy(true)));
